...
class FileCoverageCalculator:
    ...
    def cov_rate(self):
        return FileCoverage(self._file_num, self._matched_stub_num, self._src_line_num, self._matched_stub_line_num, self._non_empty_file_num)
