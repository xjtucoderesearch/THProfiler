...
def gitlog(rootDir, projectName):
    ...
    fileName = rootDir + projectName + "/mc/history-all.csv"
    writeCSV(resList, fileName)

    resList = saveCommitCollection(commitCollection_py)
    fileName = rootDir + projectName + "/mc/history-py.csv"
    writeCSV(resList, fileName)

    resList = saveCommitCollection(commitCollection_nontest)
    fileName = rootDir + projectName + "/mc/history-notest.csv"
    writeCSV(resList, fileName)
